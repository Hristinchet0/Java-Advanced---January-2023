...
abstract class Heroes implements Hero {
    private String name;
    ...
    public String toString() {
        ...
        List<String> itemsStringsIterable =
                this.getItems()
                        .stream()
                        .map(Object::toString)
        ...
        return String.format("Hero: %s, Class: %s\n" +
                ...
                this.getHitPoints(), this.getDamage(), this.getStrength(),
                this.getAgility(), this.getIntelligence(), itemsString);
    }
}
